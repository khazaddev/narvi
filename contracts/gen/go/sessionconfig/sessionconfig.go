...
type SessionConfig struct {
	...
	// (§17.2): true exactly for a sentinel-auto-fix child session
	...
	// (§27.5): this session's own Environment.docker_required. Carried here
	...
	// (§27.6): this session's own Environment.egress_policy, enforced at the
	...
	// (§26.4): the counter-review sub-task's own opposing-model-family
