...
type Item struct {
	...
	// outbox's own similarly-approximated timestamps (Step 60 review finding
	...
	// determined (countOpenFindings itself errored) -- Step 60 review finding
	...
	// IsHandoff immediately above (Step 60 review finding A4: this field used
	...
	// LATEST review (Step 60 review finding P1-1). UNLIKE HasApprovingReview
	// above, this DOES gate an action -- RevalidateForMerge treats a true
	// value as a hard merge block (Step 60 review finding A4) -- so
