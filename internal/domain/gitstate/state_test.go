...
// is not in the transitions table: mismatched pairs among the five
...
// TestIsTerminal covers all ten states, proving the terminal set is
// exactly {ready, stash_failed, checkout_failed_clean,
// checkout_failed_with_stash, pop_failed}, plus an unrecognized state.
...
// TestRequiresStashRecovery is the exhaustive truth table over all ten
...
// PopFailed -- every other state, including the other three terminal
// states and Ready, must read false.
