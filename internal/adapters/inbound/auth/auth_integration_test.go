...
// both the pool and the container. Identical in shape to httpapi's own
// newTestPool (httpapi_integration_test.go) -- see this file's own top
// comment for why it isn't shared.
