...
func TestDecidePlan_CrossChannelNotify_SlackMessageUpdated(t *testing.T) {
	...
	outcome, err := httpapi.DecidePlan(ctx, rig.pool, rig.sessions, rig.turns, rig.plans, rig.outbox, rig.linearAgentSessions, rig.registry,
...
func TestDecidePlan_CrossSessionPlanIDDoesNotLeakStatus(t *testing.T) {
	...
	var noDecider pgtype.UUID
	decideOutcome, err := httpapi.DecidePlan(ctx, rig.pool, rig.sessions, rig.turns, rig.plans, rig.outbox, rig.linearAgentSessions, rig.registry,
