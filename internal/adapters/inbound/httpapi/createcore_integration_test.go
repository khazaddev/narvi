...
// Integration tests for the exported CreateSessionCore function itself
// (Step 31, "webhook toolkit" extraction) -- deliberately in package
// httpapi (not httpapi_test, unlike this package's other integration
// tests) since CreateSessionCore started as CreateSession's own
// unexported internal implementation detail before being exported so
// Steps 32-34's webhook-specific callers could reuse it directly. This
// file builds its own minimal testcontainers-Postgres rig
