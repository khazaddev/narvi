...
// *_integration_test.go files keeps compiling unchanged (except
// postgres_integration_test.go's own TestSchemaSqlcStoresPipeline, which
// never called this helper to begin with and keeps its own dedicated
// container -- see sharedpool_integration_test.go's own top doc comment
// for why). See that file's own top doc comment for the full
// container-reuse story.
